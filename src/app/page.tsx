...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: q ? `${BASE_URL}/?q=${encodeURIComponent(q)}` : BASE_URL,
      siteName: 'IntentForge by Oxiverse',
      locale: 'en_US',
      type: 'website',
      images: [{ url: '/assets/oxiverse.png', width: 1200, height: 630, alt: 'IntentForge by Oxiverse — Intent-First Search Engine' }],
    },
    twitter: {
